            ...
            <div className="tp-slider-item tp-slider-height d-flex align-items-center swiper-slide green-dark-bg">
              <div className="tp-slider-shape">
                <img
                  ...
                  src="/src/assets/img/slider/shape/slider-shape-1.png"
                  alt="slider-shape"
                />
                <img
                  className="tp-slider-shape-2"
                  src="/src/assets/img/slider/shape/slider-shape-2.png"
                  alt="slider-shape"
                />
                <img
                  className="tp-slider-shape-3"
                  src="/src/assets/img/slider/shape/slider-shape-3.png"
                  alt="slider-shape"
                />
                <img
                  className="tp-slider-shape-4"
                  src="/src/assets/img/slider/shape/slider-shape-4.png"
                  alt="slider-shape"
                />
              </div>
                ...
                <div className="row align-items-center">
                  ...
                  <div className="col-xl-7 col-lg-6 col-md-6">
                    <div className="tp-slider-thumb text-end">
                      <img
                        src="/src/assets/img/slider/slider-img-1.png"
                        alt="slider-img"
                      />
                    </div>
                  </div>
              ...
              <div className="container">
                <div className="row align-items-center">
                  ...
                  <div className="col-xl-7 col-lg-6 col-md-6">
                    <div className="tp-slider-thumb text-end">
                      <img
                        src="/src/assets/img/slider/slider-img-2.png"
                        alt="slider-img"
                      />
                    </div>
                  </div>
              ...
              <div className="container">
                <div className="row align-items-center">
                  ...
                  <div className="col-xl-7 col-lg-6 col-md-6">
                    <div className="tp-slider-thumb text-end">
                      <img
                        src="/src/assets/img/slider/slider-img-3.png"
                        alt="slider-img"
                      />
                    </div>
                  </div>
              ...
              <div className="tp-product-category-item text-center mb-40">
                <div className="tp-product-category-thumb fix">
                  <a href="shop-category.html">
                    <img
                      src="/src/assets/img/product/category/product-cat-1.png"
            ...
            <div className="col">
              <div className="tp-product-category-item text-center mb-40">
                <div className="tp-product-category-thumb fix">
                  <a href="shop-category.html">
                    <img
                      src="/src/assets/img/product/category/product-cat-2.png"
                      alt="product-category"
                    />
                  </a>
                </div>
            ...
            <div className="col">
              <div className="tp-product-category-item text-center mb-40">
                <div className="tp-product-category-thumb fix">
                  <a href="shop-category.html">
                    <img
                      src="/src/assets/img/product/category/product-cat-3.png"
                      alt="product-category"
                    />
                  </a>
                </div>
            ...
            <div className="col">
              <div className="tp-product-category-item text-center mb-40">
                <div className="tp-product-category-thumb fix">
                  <a href="shop-category.html">
                    <img
                      src="/src/assets/img/product/category/product-cat-4.png"
                      alt="product-category"
                    />
                  </a>
                </div>
            ...
            <div className="col">
              <div className="tp-product-category-item text-center mb-40">
                <div className="tp-product-category-thumb fix">
                  <a href="shop-category.html">
                    <img
                      src="/src/assets/img/product/category/product-cat-5.png"
                      alt="product-category"
                    />
                  </a>
                </div>
                        ...
                        <div className="tp-product-item p-relative transition-3 mb-25">
                          <div className="tp-product-thumb p-relative fix m-img">
                            <a href="product-details.html">
                              <img
                                src="/src/assets/img/product/product-1.jpg"
                      ...
                      <div className="col-xl-3 col-lg-3 col-sm-6">
                        <div className="tp-product-item transition-3 mb-25">
                          <div className="tp-product-thumb p-relative fix m-img">
                            <a href="product-details.html">
                              <img
                                src="/src/assets/img/product/product-2.jpg"
                                alt="product-electronic"
                              />
                            </a>
                            <div className="tp-product-badge">
                      ...
                      <div className="col-xl-3 col-lg-3 col-sm-6">
                        <div className="tp-product-item transition-3 mb-25">
                          <div className="tp-product-thumb p-relative fix m-img">
                            <a href="product-details.html">
                              <img
                                src="/src/assets/img/product/product-3.jpg"
                                alt="product-electronic"
                              />
                            </a>
                            <div className="tp-product-badge">
                      ...
                      <div className="col-xl-3 col-lg-3 col-sm-6">
                        <div className="tp-product-item transition-3 mb-25">
                          <div className="tp-product-thumb p-relative fix m-img">
                            <a href="product-details.html">
                              <img
                                src="/src/assets/img/product/product-4.jpg"
                                alt="product-electronic"
                              />
                            </a>
                            <div className="tp-product-action">
                      ...
                      <div className="col-xl-3 col-lg-3 col-sm-6">
                        <div className="tp-product-item transition-3 mb-25">
                          <div className="tp-product-thumb p-relative fix m-img">
                            <a href="product-details.html">
                              <img
                                src="/src/assets/img/product/product-5.jpg"
                                alt="product-electronic"
                              />
                            </a>
                            <div className="tp-product-badge">
                      ...
                      <div className="col-xl-3 col-lg-3 col-sm-6">
                        <div className="tp-product-item transition-3 mb-25">
                          <div className="tp-product-thumb p-relative fix m-img">
                            <a href="product-details.html">
                              <img
                                src="/src/assets/img/product/product-5-1.jpg"
                                alt="product-electronic"
                              />
                            </a>
                            <div className="tp-product-action">
                          ...
                          <div className="tp-product-content">
                            ...
                            <h3 className="tp-product-title">
                              <a href="product-details.html">
                                CPU Cooler 2 Heat Pipes 12mm 4 Pin PWM RGB for
                                Intel.
                              </a>
                            </h3>
                            <div className="tp-product-rating d-flex align-items-center">
                      ...
                      <div className="col-xl-3 col-lg-3 col-sm-6">
                        <div className="tp-product-item transition-3 mb-25">
                          <div className="tp-product-thumb p-relative fix m-img">
                            <a href="product-details.html">
                              <img
                                src="/src/assets/img/product/product-5-2.jpg"
                                alt="product-electronic"
                              />
                            </a>
                            <div className="tp-product-badge">
                      ...
                      <div className="col-xl-3 col-lg-3 col-sm-6">
                        <div className="tp-product-item transition-3 mb-25">
                          <div className="tp-product-thumb p-relative fix m-img">
                            <a href="product-details.html">
                              <img
                                src="/src/assets/img/product/product-5-3.jpg"
                                alt="product-electronic"
                              />
                            </a>
                            <div className="tp-product-badge">
          ...
          <div className="row">
            <div className="col-xl-8 col-lg-7">
              <div className="tp-banner-item tp-banner-height p-relative mb-30 z-index-1 fix">
                <div
                  ...
                  data-background="/src/assets/img/product/banner/product-banner-1.jpg"
                />
            ...
            <div className="col-xl-4 col-lg-5">
              <div className="tp-banner-item tp-banner-item-sm tp-banner-height p-relative mb-30 z-index-1 fix">
                <div
                  className="tp-banner-thumb include-bg transition-3"
                  data-background="/src/assets/img/product/banner/product-banner-2.jpg"
                />
                <div className="tp-banner-content">
                  <h3 className="tp-banner-title">
                    <a href="product-details.html">
                  ...
                  <div className="swiper-wrapper">
                    <div className="tp-product-offer-item tp-product-item transition-3 swiper-slide">
                      <div className="tp-product-thumb p-relative fix m-img">
                        <a href="product-details.html">
                          <img
                            src="/src/assets/img/product/offer/product-offer-1.jpg"
                            alt="product-electronic"
                          />
                        </a>
                        <div className="tp-product-action">
                    ...
                    <div className="tp-product-offer-item tp-product-item transition-3 swiper-slide">
                      <div className="tp-product-thumb p-relative fix m-img">
                        <a href="product-details.html">
                          <img
                            src="/src/assets/img/product/offer/product-offer-2.jpg"
                            alt="product-electronic"
                          />
                        </a>
                        {/* product action */}
                    ...
                    <div className="tp-product-offer-item tp-product-item transition-3 swiper-slide">
                      <div className="tp-product-thumb p-relative fix m-img">
                        <a href="product-details.html">
                          <img
                            src="/src/assets/img/product/offer/product-offer-3.jpg"
                            alt="product-electronic"
                          />
                        </a>
                        {/* product action */}
              ...
              <div className="tp-product-gadget-sidebar mb-40">
                <div className="tp-product-gadget-categories p-relative fix mb-10">
                  ...
                  <div className="tp-product-gadget-categories-list">
                    <ul>
                      <li>
                        <a href="shop-category.html">Micrscope</a>
                      </li>
                      <li>
                        <a href="shop-category.html">Remote Control</a>
                      </li>
                      <li>
                        <a href="shop-category.html">Monitor</a>
                      </li>
                      <li>
                        <a href="shop-category.html">Thermometer</a>
                      </li>
                      <li>
                        <a href="shop-category.html">Backpack</a>
                      </li>
                      <li>
                        <a href="shop-category.html">Headphones</a>
                      </li>
                  ...
                  <div className="tp-product-gadget-banner-slider-active swiper-container">
                    <div className="swiper-wrapper">
                      <div
                        ...
                        data-background="/src/assets/img/product/gadget/gadget-banner-1.jpg"
                      >
                      ...
                      <div
                        className="tp-product-gadget-banner-item swiper-slide include-bg"
                        data-background="/src/assets/img/product/gadget/gadget-banner-2.jpg"
                      >
                        <div className="tp-product-gadget-banner-content">
                          <span className="tp-product-gadget-banner-price">
                            Only $55.00
                  ...
                  <div className="col-xl-4 col-sm-6">
                    <div className="tp-product-item p-relative transition-3 mb-25">
                      <div className="tp-product-thumb p-relative fix m-img">
                        <a href="product-details.html">
                          <img
                            src="/src/assets/img/product/product-12.jpg"
                            alt="product-electronic"
                          />
                        </a>
                        {/* product badge */}
                  ...
                  <div className="col-xl-4 col-sm-6">
                    <div className="tp-product-item p-relative transition-3 mb-25">
                      <div className="tp-product-thumb p-relative fix m-img">
                        <a href="product-details.html">
                          <img
                            src="/src/assets/img/product/product-13.jpg"
                            alt="product-electronic"
                          />
                        </a>
                        {/* product action */}
                  ...
                  <div className="col-xl-4 col-sm-6">
                    <div className="tp-product-item p-relative transition-3 mb-25">
                      <div className="tp-product-thumb p-relative fix m-img">
                        <a href="product-details.html">
                          <img
                            src="/src/assets/img/product/product-14.jpg"
                            alt="product-electronic"
                          />
                        </a>
                        {/* product badge */}
                  ...
                  <div className="col-xl-4 col-sm-6">
                    <div className="tp-product-item p-relative transition-3 mb-25">
                      <div className="tp-product-thumb p-relative fix m-img">
                        <a href="product-details.html">
                          <img
                            src="/src/assets/img/product/product-15.jpg"
                            alt="product-electronic"
                          />
                        </a>
                        {/* product badge */}
                  ...
                  <div className="col-xl-4 col-sm-6">
                    <div className="tp-product-item p-relative transition-3 mb-25">
                      <div className="tp-product-thumb p-relative fix m-img">
                        <a href="product-details.html">
                          <img
                            src="/src/assets/img/product/product-16.jpg"
                            alt="product-electronic"
                          />
                        </a>
                        {/* product badge */}
                  ...
                  <div className="col-xl-4 col-sm-6">
                    <div className="tp-product-item p-relative transition-3 mb-25">
                      <div className="tp-product-thumb p-relative fix m-img">
                        <a href="product-details.html">
                          <img
                            src="/src/assets/img/product/product-17.jpg"
                            alt="product-electronic"
                          />
                        </a>
                        {/* product action */}
                      ...
                      <div className="tp-product-banner-thumb-wrapper p-relative">
                        <div className="tp-product-banner-thumb-shape">
                          ...
                          <img
                            ...
                            src="/src/assets/img/banner/banner-slider-offer.png"
                            alt=""
                          />
                        </div>
                  ...
                  <div className="swiper-wrapper">
                    <div className="tp-product-item transition-3 mb-25 swiper-slide">
                      <div className="tp-product-thumb p-relative fix m-img">
                        <a href="product-details.html">
                          <img
                            src="/src/assets/img/product/product-6.jpg"
                            alt="product-electronic"
                          />
                        </a>
                        {/* product badge */}
                    ...
                    <div className="tp-product-item transition-3 mb-25 swiper-slide ">
                      <div className="tp-product-thumb p-relative fix m-img">
                        <a href="product-details.html">
                          <img
                            src="/src/assets/img/product/product-7.jpg"
                            alt="product-electronic"
                          />
                        </a>
                        {/* product action */}
                    ...
                    <div className="tp-product-item transition-3 mb-25 swiper-slide ">
                      <div className="tp-product-thumb p-relative fix m-img">
                        <a href="product-details.html">
                          <img
                            src="/src/assets/img/product/product-8.jpg"
                            alt="product-electronic"
                          />
                        </a>
                        {/* product badge */}
                    ...
                    <div className="tp-product-item transition-3 mb-25 swiper-slide ">
                      <div className="tp-product-thumb p-relative fix m-img">
                        <a href="product-details.html">
                          <img
                            src="/src/assets/img/product/product-9.jpg"
                            alt="product-electronic"
                          />
                        </a>
                        {/* product badge */}
                    ...
                    <div className="tp-product-item transition-3 mb-25 swiper-slide ">
                      <div className="tp-product-thumb p-relative fix m-img">
                        <a href="product-details.html">
                          <img
                            src="/src/assets/img/product/product-10.jpg"
                            alt="product-electronic"
                          />
                        </a>
                        {/* product badge */}
                ...
                <div className="tp-product-sm-wrapper mr-20">
                  <div className="tp-product-sm-item d-flex align-items-center">
                    ...
                    <div className="tp-product-sm-content">
                      ...
                      <h3 className="tp-product-title">
                        <a href="product-details.html">Oppo A96 5G Mobile Phone</a>
                      </h3>
          ...
          <div className="row row-cols-lg-5 row-cols-md-3 row-cols-sm-2 row-cols-1">
            <div className="col">
              <div className="tp-instagram-item p-relative z-index-1 fix mb-30 w-img">
                ...
                <div className="tp-instagram-icon">
                  <a
                    href="/src/assets/img/instagram/instagram-1.jpg"
            ...
            <div className="col">
              <div className="tp-instagram-item p-relative z-index-1 fix mb-30 w-img">
                ...
                <div className="tp-instagram-icon">
                  <a
                    href="/src/assets/img/instagram/instagram-2.jpg"
                    className="popup-image"
                  >
                    <i className="fa-brands fa-instagram" />
                  </a>
            ...
            <div className="col">
              <div className="tp-instagram-item p-relative z-index-1 fix mb-30 w-img">
                ...
                <div className="tp-instagram-icon">
                  <a
                    href="/src/assets/img/instagram/instagram-3.jpg"
                    className="popup-image"
                  >
                    <i className="fa-brands fa-instagram" />
                  </a>
            ...
            <div className="col">
              <div className="tp-instagram-item p-relative z-index-1 fix mb-30 w-img">
                ...
                <div className="tp-instagram-icon">
                  <a
                    href="/src/assets/img/instagram/instagram-4.jpg"
                    className="popup-image"
                  >
                    <i className="fa-brands fa-instagram" />
                  </a>
            ...
            <div className="col">
              <div className="tp-instagram-item p-relative z-index-1 fix mb-30 w-img">
                ...
                <div className="tp-instagram-icon">
                  <a
                    href="/src/assets/img/instagram/instagram-5.jpg"
                    className="popup-image"
                  >
                    <i className="fa-brands fa-instagram" />
                  </a>
      ...
      <section className="tp-subscribe-area pt-70 pb-65 theme-bg p-relative z-index-1">
        <div className="tp-subscribe-shape">
          <img
            ...
            src="/src/assets/img/subscribe/subscribe-shape-1.png"
            alt=""
          />
          <img
            className="tp-subscribe-shape-2"
            src="/src/assets/img/subscribe/subscribe-shape-2.png"
            alt=""
          />
          <img
            className="tp-subscribe-shape-3"
            src="/src/assets/img/subscribe/subscribe-shape-3.png"
            alt=""
          />
          <img
            className="tp-subscribe-shape-4"
            src="/src/assets/img/subscribe/subscribe-shape-4.png"
            alt=""
          />
          {/* plane shape */}
          <div className="tp-subscribe-plane">
            <img
              ...
              src="/src/assets/img/subscribe/plane.png"
              alt=""
            />
            <svg
              width={399}
              ...
              <div className="tp-product-details-thumb-wrapper tp-tab d-sm-flex">
                <nav>
                  ...
                  >
                    ...
                    >
                      <img
                        src="/src/assets/img/product/details/nav/product-details-nav-1.jpg"
                        alt=""
                      />
                    </button>
                    <button
                    ...
                    >
                      <img
                        src="/src/assets/img/product/details/nav/product-details-nav-2.jpg"
                        alt=""
                      />
                    </button>
                    <button
                    ...
                    >
                      <img
                        src="/src/assets/img/product/details/nav/product-details-nav-3.jpg"
                        alt=""
                      />
                    </button>
                    <button
                    ...
                    >
                      <img
                        src="/src/assets/img/product/details/nav/product-details-nav-4.jpg"
                        alt=""
                      />
                    </button>
                  </div>
                ...
                <div className="tab-content m-img" id="productDetailsNavContent">
                  ...
                  >
                    <div className="tp-product-details-nav-main-thumb">
                      <img
                        src="/src/assets/img/product/details/main/product-details-main-1.jpg"
                        alt=""
                      />
                    </div>
                  </div>
                  ...
                  >
                    <div className="tp-product-details-nav-main-thumb">
                      <img
                        src="/src/assets/img/product/details/main/product-details-main-2.jpg"
                        alt=""
                      />
                    </div>
                  </div>
                  ...
                  >
                    <div className="tp-product-details-nav-main-thumb">
                      <img
                        src="/src/assets/img/product/details/main/product-details-main-3.jpg"
                        alt=""
                      />
                    </div>
                  </div>
                  ...
                  >
                    <div className="tp-product-details-nav-main-thumb">
                      <img
                        src="/src/assets/img/product/details/main/product-details-main-4.jpg"
                        alt=""
                      />
                    </div>
                  </div>
