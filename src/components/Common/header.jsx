                          ...
                          <li className="has-dropdown">
                            ...
                            <ul className="mega-menu tp-submenu">
                              <li>
                                ...
                                <ul>
                                  <li>
                                    <a href="shop.html"><img src="/src/assets/img/header/menu/menu-1.jpg" alt="" /></a>
                                  </li>
                                  <li>
                              ...
                              <li>
                                ...
                                <ul>
                                  <li>
                                    <a href="shop.html"><img src="/src/assets/img/header/menu/menu-2.jpg" alt="" /></a>
                                  </li>
                                  <li>
                              ...
                              <li>
                                ...
                                <ul>
                                  <li>
                                    <a href="shop.html"><img src="/src/assets/img/header/menu/menu-3.jpg" alt="" /></a>
                                  </li>
                                  <li>
